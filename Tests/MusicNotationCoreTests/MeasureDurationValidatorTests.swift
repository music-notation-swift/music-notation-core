    ...
    override func setUp() {
        ...
        let dotted16: Note = {
            return Note(
                ...
                pitch: Pitch(noteLetter: .c, octave: .octave0))
        }()
        ...
        let quarter = Note(noteDuration: .quarter, pitch: Pitch(noteLetter: .c, octave: .octave0))
        let thirtySecond = Note(noteDuration: .thirtySecond, pitch: Pitch(noteLetter: .c, octave: .octave0))
